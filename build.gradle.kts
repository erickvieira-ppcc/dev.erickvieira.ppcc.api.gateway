...
group = "dev.erickvieira.ppcc.api"
...
dependencies {
    ...
    val springCloudFeaturesVersion = "3.1.0"
    ...
    implementation("org.springframework.cloud:spring-cloud-starter-gateway:$springCloudFeaturesVersion")
    implementation("org.springframework.cloud:spring-cloud-starter-netflix-eureka-client:$springCloudFeaturesVersion")
